...
const AcademyPage = () => {
  ...
  return (
    <div className="min-h-screen pb-20 md:pb-0">
      ...
      <section className={cn("relative flex items-center justify-center overflow-hidden", visibleHeroPics.length > 0 ? "min-h-[38vh]" : "pt-24 pb-10")}>
        ...
        <div className={cn("relative z-10 container mx-auto px-6 text-center", visibleHeroPics.length > 0 ? "py-20" : "")}>
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="flex items-center justify-center gap-3 mb-4">
              <AcademiesIcon className="h-6 w-6 sm:h-8 sm:w-8 text-primary" />
      ...
      <div className="container mx-auto px-6 pb-16">
        ...
        {filteredClubs.length === 0 && (
          <div className="text-center py-20">
            <AcademiesIcon className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
